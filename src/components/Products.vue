<template>
  <section class="products">
    <div class="container">
      <h2 v-scroll-reveal.reset class="products__title">Menu</h2>

      <div class="products__buttons" v-scroll-reveal.reset="{ delay: 250 }">
        <md-button
      ...
      <div class="products__list" v-scroll-reveal.reset="{ delay: 450 }">
        <md-card
